        ...
        <ul class="header-menu nav navbar-nav">
            ...
            <li class="dropdown" id="notifications-header">
                ...
                <ul class="dropdown-menu">
                    <li class="dropdown-header clearfix">
                        <p class="pull-left">12 Notificaciones pendientes</p>
                    </li>
                    <li>
            ...
            <li class="dropdown" id="user-header">
                <a href="#" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                    ...
                    <span class="username">Hola, Administrador CIDECUC</span>
                </a>
                <ul class="dropdown-menu">
                    <li>
                    ...
                    <li>
                        <a href="#"><i class="icon-calendar"></i><span>Calendario</span></a>
                    </li>
                    <li>
                        <a href="#"><i class="icon-settings"></i><span>Preferencias</span></a>
                    </li>
                    <li>
                        <a href="/login"><i class="icon-logout"></i><span>Cerrar sesión</span></a>
                    </li>
                </ul>
            </li>
            <!-- END USER DROPDOWN -->
